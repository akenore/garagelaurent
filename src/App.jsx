               ...
               <div className="bg-vGray-20 scroll-smooth">
                    <main className="bg-hero-mobile md:bg-hero-web bg-contain bg-no-repeat">
                         ...
                         <div className="pt-10 md:pt-40 xl:pt-72">
                              ...
                              <section className="flex justify-center mb-20">
                                   <div className="mx-5">
                                        <div className="flex justify-center pt-10 xl:pt-70 2xl:pt-80">
                                             <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10 xl:gap-20"></div>
                                        </div>
                                        <div className="pt-20 md:pt-52 xl:pt-64 2xl:pt-80 mb-8 flex items-center">
                                             <h1 className="font-bold text-2xl md:text-4xl uppercase text-red2">Un aperçu de notre atelier</h1>
                                             <svg className="ml-1 hidden md:block" xmlns="http://www.w3.org/2000/svg" width="56" height="5" viewBox="0 0 56 5">
                              ...
                              <section id='services' className="bg-vGray-20">
